...
class CreateIndexGenerator(
    private val db: EffectiveSettings,
...
CREATE ${
        ...
        }INDEX ${indexName.toQuoted()} ON ${table.toQuoted()}(${joinQuotableValues(
            columnReferences,
        )}) ${(tablespace ?: db.defaultIndexTablespace).toQuoted { " TABLESPACE $it " }}
        """.trimIndent()
    }
}
