...
import net.futureset.kontroldb.dsl.addForeignKey
...
import net.futureset.kontroldb.dsl.scriptComment
...
class CreateCustomerSaleTable :
    Refactoring(
        ...
        forward =
        changes {
            scriptComment("A table to store customer sales single line")
